      ...
      <FadeUpAnimation className="container">
        <div className="relative z-10 text-center ">
          ...
          <h1 className="mb-12 max-md:mb-8">
            Presenting the forefront of <br /> Drupal excellence.
          </h1>
          <p className="mx-auto mb-12 max-w-[590px] max-md:mb-8">
            We transform enterprise digital platforms through advanced Drupal solutions.
            <br />
            Our expertise lies in building robust, scalable systems that become your competative advantage.
          </p>
