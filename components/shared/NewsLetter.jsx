    ...
    <section className="relative pb-25 max-md:overflow-hidden max-md:pb-25">
      <div className="container relative max-md:text-center">
        <div className="absolute -bottom-[442px] left-1/2 -z-10  flex -translate-x-1/2 max-md:hidden max-md:flex-col">
          <div className="rounded-full bg-[url('/images/hero-gradient.png')] blur-[145px]  max-1xl:h-[335px] max-1xl:w-[335px]  max-md:hidden 1xl:h-[442px] 1xl:w-[442px]"></div>
        ...
        <div>
          ...
          <div className="grid-y-10 grid grid-cols-12 items-start">
            <div className="max-md:col-span-full md:col-span-6 lg:col-span-7">
              <h2 className="mb-5 text-[48px] font-semibold max-lg:text-[32px]">Get Started with your Drupal Today</h2>
              <p>we turn your digital version into seamless, high performing experience tailored to your needs.</p>
            </div>
