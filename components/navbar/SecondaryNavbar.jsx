      ...
      <div
        ...
        <nav className="container relative flex items-center">
          <div className="nav-logo">
            <Link href="/">
              <Image src={menuData.logoLight} alt="logo" className="dark:hidden" width={181} height={32} priority />
              <Image
          ...
          <ul className="nav-list !ml-auto !mr-8 hidden lg:ml-7 lg:flex xl:ml-15 [&>*:not(:last-child)]:me-1">
